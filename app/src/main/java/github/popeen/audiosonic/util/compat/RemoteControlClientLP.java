...
public class RemoteControlClientLP extends RemoteControlClientBase {
	...
	private static final String CUSTOM_ACTION_BACK = "github.popeen.dsub.BACK";
	private static final String CUSTOM_ACTION_FORWARD = "github.popeen.dsub.FORWARD";
	private static final String CUSTOM_ACTION_STAR = "github.popeen.dsub.STAR";
	private static final String CUSTOM_ACTION_SLOW = "github.popeen.dsub.SLOW";
	private static final String CUSTOM_ACTION_FAST = "github.popeen.dsub.FAST";
	...
	public void register(Context context, ComponentName mediaButtonReceiverComponent) {
		...
		sessionExtras.putBoolean(AUTO_RESERVE_SKIP_TO_PREVIOUS, false);
		sessionExtras.putBoolean(AUTO_RESERVE_SKIP_TO_NEXT, false);
	...
	protected void addCustomActions(Entry currentSong, PlaybackStateCompat.Builder builder) {
		...
		PlaybackStateCompat.CustomAction skipBackward = new PlaybackStateCompat.CustomAction.Builder(CUSTOM_ACTION_BACK,
					"Skip Back",
				R.drawable.ic_replay_30_black_48dp)
				.setExtras(showOnWearExtras).build();

		PlaybackStateCompat.CustomAction skipForward = new PlaybackStateCompat.CustomAction.Builder(CUSTOM_ACTION_FORWARD,
					"Skip Forward",
		...
		builder.addCustomAction(skipBackward).addCustomAction(skipForward).addCustomAction(star).addCustomAction(slow).addCustomAction(fast);
	}
