...
package github.popeen.audiosonic.service.sync;
...
import github.popeen.audiosonic.service.parser.SubsonicRESTException;
import github.popeen.audiosonic.util.FileUtil;
import github.popeen.audiosonic.util.Notifications;
import github.popeen.audiosonic.util.SyncUtil;
import github.popeen.audiosonic.util.SyncUtil.SyncSet;
...
public class PlaylistSyncAdapter extends SubsonicSyncAdapter {
	...
	public void onExecuteSync(Context context, int instance) throws NetworkNotValidException {
		...
		if(updated.size() > 0) {
			Notifications.showSyncNotification(context, R.string.sync_new_p