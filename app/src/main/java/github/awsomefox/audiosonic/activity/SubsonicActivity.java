...
import github.awsomefox.audiosonic.fragments.UserFragment;
...
import github.awsomefox.audiosonic.fragments.AdminFragment;
import github.awsomefox.audiosonic.service.DownloadService;
import github.awsomefox.audiosonic.service.HeadphoneListenerService;
	...
	private static class SubsonicUncaughtExceptionHandler implements Thread.UncaughtExceptionHandler {
		...
		public void uncaughtException(Thread thread, Throwable throwable) {
			...
			try {
				...
				PackageInfo packageInfo = context.getPackageManager().getPackageInfo("github.awsomefox.audiosonic", 0);
				file = new File(Environment.getExternalStorageDirectory(), "audiosonic-stacktrace.txt");
