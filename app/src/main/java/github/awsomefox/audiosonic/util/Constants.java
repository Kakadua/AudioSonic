...
public final class Constants {
    ...
    public static final String PREFERENCES_FILE_NAME = "github.awsomefox.audiosonic_preferences";
	public static final String OFFLINE_SYNC_NAME = "github.awsomefox.audiosonic.offline";
