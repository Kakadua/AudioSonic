...
public class ImageLoader {
	...
	public ImageLoader(Context context) {
		...
		avatarSizeDefault = context.getResources().getDrawable(R.drawable.ic_person_outline_white_48dp).getIntrinsicHeight();
	...
	public SilentBackgroundTask<Void> loadAvatar(Context context, ImageView view, String username) {
		if(username == null) {
			view.setImageResource(R.drawable.ic_person_outline_white_48dp);
			return null;
		}
	...
	private class AvatarTask extends SilentBackgroundTask<Void> {
		...
		protected void done(Void result) {
			if(mDrawable != null) {
				...
				mView.setImageDrawable(DrawableTint.getTintedDrawable(context, R.drawable.ic_social_person));
			}
		}
	}
}
