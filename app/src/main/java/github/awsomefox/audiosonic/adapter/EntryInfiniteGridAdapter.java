...
public class EntryInfiniteGridAdapter extends EntryGridAdapter {
	...
	public EntryInfiniteGridAdapter(Context context, List<MusicDirectory.Entry> entries, ImageLoader imageLoader, boolean largeCell) {
	...
	protected void appendCachedData(List<MusicDirectory.Entry> newData) {
		if(newData.size() > 0) {
