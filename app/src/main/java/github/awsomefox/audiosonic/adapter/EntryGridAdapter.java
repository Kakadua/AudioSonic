...
public class EntryGridAdapter extends SectionAdapter<MusicDirectory.Entry> {
	...
	public EntryGridAdapter(Context context, List<MusicDirectory.Entry> entries, ImageLoader imageLoader, boolean largeCell) {
	...
	@Override
	public void onBindViewHolder(UpdateView.UpdateViewHolder holder, MusicDirectory.Entry entry, int viewType) {
