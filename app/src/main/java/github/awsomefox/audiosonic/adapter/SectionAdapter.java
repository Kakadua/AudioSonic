...
public abstract class SectionAdapter<T> extends RecyclerView.Adapter<UpdateView.UpdateViewHolder<T>> {
	...
	public UpdateView.UpdateViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
		if(viewType == VIEW_TYPE_HEADER) {
			...
			final UpdateView.UpdateViewHolder<T> holder = onCreateSectionViewHolder(parent, viewType);
	...
	public abstract void onBindViewHolder(UpdateView.UpdateViewHolder holder, T item, int viewType);
