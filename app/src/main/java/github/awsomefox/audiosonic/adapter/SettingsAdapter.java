...
package github.awsomefox.audiosonic.adapter;
...
import github.awsomefox.audiosonic.view.BasicHeaderView;
import github.awsomefox.audiosonic.view.RecyclingImageView;
import github.awsomefox.audiosonic.view.SettingView;
...
public class SettingsAdapter extends SectionAdapter<User.Setting> {
	...
	public SettingsAdapter(Context context, User user, List<String> headers, List<List<User.Setting>> settingSections, ImageLoader imageLoader, boolean editable, OnItemClickedListener<User.Setting> onItemClickedListener) {
		...
		for(List<User.Setting> settings: sections) {
	...
	public static SettingsAdapter getSettingsAdapter(Context context, User user, ImageLoader imageLoader, OnItemClickedListener<User.Setting> onItemClickedListener) {
	...
	public static SettingsAdapter getSettingsAdapter(Context context, User user, ImageLoader imageLoader, boolean isEditable, OnItemClickedListener<User.Setting> onItemClickedListener) {
